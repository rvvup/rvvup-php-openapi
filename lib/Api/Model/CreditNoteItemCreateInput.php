...
/**
 * CreditNoteItemCreateInput Class Doc Comment
 *
 * @category Class
 ...
 */
class CreditNoteItemCreateInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditNoteItemCreateInput';
    ...
    */
     ...
     *
     * @param string|null $invoice_item_id The ID of the invoice item this credit note item is for.
     *
     * @return self
     */
    public function setInvoiceItemId($invoice_item_id)
    {
        if (is_null($invoice_item_id)) {
            throw new \InvalidArgumentException('non-nullable invoice_item_id cannot be null');
        }
     ...
     * Sets merchant_id
     *
     * @param string $merchant_id The ID of the merchant that owns this credit note item.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The name of the credit note item.
     *
     * @return self
     */
     ...
     * Sets tax_rate
     *
     * @param string|null $tax_rate The tax rate of the credit note item.
     *
     * @return self
     */
