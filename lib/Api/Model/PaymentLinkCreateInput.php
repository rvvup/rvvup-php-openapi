...
/**
 * PaymentLinkCreateInput Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentLinkCreateInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentLinkCreateInput';
    ...
    */
     ...
     *
     * @param string|null $checkout_template_id The ID of the checkout template to use for this payment link.                          If not provided, the default template will be used.                          If provided, the template must be available to the merchant.
     *
     * @return self
     */
    ...
    public function setReference($reference)
    {
        ...
        if ((mb_strlen($reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling PaymentLinkCreateInput., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($reference) < 1)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling PaymentLinkCreateInput., must be bigger than or equal to 1.');
        }
     ...
     * Sets reusable
     *
     * @param bool|null $reusable Whether the payment link can be reused for multiple payments.
     *
     * @return self
     */
