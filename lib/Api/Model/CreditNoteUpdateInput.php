    ...
    */
    ...
    public function setCreditNoteNumber($credit_note_number)
    {
        ...
        if ((mb_strlen($credit_note_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $credit_note_number when calling CreditNoteUpdateInput., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($credit_note_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $credit_note_number when calling CreditNoteUpdateInput., must be bigger than or equal to 1.');
        }
