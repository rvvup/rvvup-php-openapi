...
/**
 * InvoiceCreateInput Class Doc Comment
 *
 * @category Class
 ...
 */
class InvoiceCreateInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceCreateInput';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['customer_account_id'] === null) {
            $invalidProperties[] = "'customer_account_id' can't be null";
        }
     ...
     * Sets chaser_plan_id
     *
     * @param string|null $chaser_plan_id The ID of the chaser plan to use.
     *
     * @return self
     */
     ...
     *
     * @param string $customer_account_id The ID of the customer account to invoice.
     *
     * @return self
     */
    ...
    public function setCustomerNotes($customer_notes)
    {
        ...
        if ((mb_strlen($customer_notes) > 255)) {
            throw new \InvalidArgumentException('invalid length for $customer_notes when calling InvoiceCreateInput., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($customer_notes) < 0)) {
            throw new \InvalidArgumentException('invalid length for $customer_notes when calling InvoiceCreateInput., must be bigger than or equal to 0.');
        }
    ...
    public function setInvoiceNumber($invoice_number)
    {
        ...
        if ((mb_strlen($invoice_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $invoice_number when calling InvoiceCreateInput., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($invoice_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $invoice_number when calling InvoiceCreateInput., must be bigger than or equal to 1.');
        }
