...
/**
 * InvoiceItemCreateInput Class Doc Comment
 *
 * @category Class
 ...
 */
class InvoiceItemCreateInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceItemCreateInput';
    ...
    protected static $openAPITypes = [
        ...
        'quantity' => 'string',
        'sku' => 'string',
        'supply_date' => '\Rvvup\Api\Model\InvoiceItemSupplyDateInputDto',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InvoiceItemCreateInput., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InvoiceItemCreateInput., must be bigger than or equal to 1.');
        }
    ...
    public function setSku($sku)
    {
        ...
        if ((mb_strlen($sku) > 128)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling InvoiceItemCreateInput., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($sku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling InvoiceItemCreateInput., must be bigger than or equal to 1.');
        }
     ...
     * Gets supply_date
     *
     * @return \Rvvup\Api\Model\InvoiceItemSupplyDateInputDto|null
     */
     ...
     * Sets supply_date
     *
     * @param \Rvvup\Api\Model\InvoiceItemSupplyDateInputDto|null $supply_date supply_date
     *
     * @return self
     */
