...
class Webhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets merchant_id
     *
     * @param string $merchant_id The ID of the merchant that the webhook belongs to.
     *
     * @return self
     */
     ...
     * Gets status
     *
     * @return \Rvvup\Api\Model\WebhookStatus
     */
     ...
     *
     * @param \Rvvup\Api\Model\WebhookEventType[] $subscribed_events The events that the webhook is subscribed to.
     *
     * @return self
     */
