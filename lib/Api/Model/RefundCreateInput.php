...
/**
 * RefundCreateInput Class Doc Comment
 *
 * @category Class
 ...
 */
class RefundCreateInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RefundCreateInput';
    ...
    */
     ...
     * Sets amount
     *
     * @param \Rvvup\Api\Model\MoneyInput $amount amount
     *
     * @return self
     */
    ...
    public function setReason($reason)
    {
        ...
        if ((mb_strlen($reason) > 255)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling RefundCreateInput., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($reason) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling RefundCreateInput., must be bigger than or equal to 0.');
        }
