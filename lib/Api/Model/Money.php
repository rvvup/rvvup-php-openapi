...
class Money implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets currency
     *
     * @param string $currency The three-letter ISO-4217 currency code of the amount.                          For cryptocurrencies, the currency code is the cryptocurrency symbol in uppercase.
     *
     * @return self
     */
