...
/**
 * CheckoutCreateInput Class Doc Comment
 *
 * @category Class
 ...
 */
class CheckoutCreateInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckoutCreateInput';
    ...
    */
     ...
     * Sets amount
     *
     * @param \Rvvup\Api\Model\MoneyInput|null $amount amount
     *
     * @return self
     */
     ...
     * Sets cancel_url
     *
     * @param string|null $cancel_url The URL to redirect the user to if the checkout does not complete successfully.                          This field supports the template variable `{{CHECKOUT_ID}}` which will be replaced with the                          created checkouts ID.
     *
     * @return self
     */
     ...
     *
     * @param string|null $checkout_template_id The ID of the checkout template to use for this checkout.                          If not provided, the default template will be used.                          If provided, the template must be available to the merchant.
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param array<string,string>|null $metadata Key value pairs to store additional information about the checkout.
     *
     * @return self
     */
     ...
     * Gets mode
     *
     * @return \Rvvup\Api\Model\CheckoutMode|null
     */
     ...
     * Sets mode_id
     *
     * @param string|null $mode_id ID related to this checkout mode. Required for the ACCOUNT_STATEMENT mode and should be set to the AccountStatement's ID.Automatically set for all other modes.
     *
     * @return self
     */
     ...
     * Sets pending_url
     *
     * @param string|null $pending_url The URL to redirect the user to if the checkout falls into a pending payment flow.                          This field supports the template variable `{{CHECKOUT_ID}}` which will be replaced with the                          created checkouts ID.
     *
     * @return self
     */
    ...
    public function setReference($reference)
    {
        ...
        if ((mb_strlen($reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling CheckoutCreateInput., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($reference) < 1)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling CheckoutCreateInput., must be bigger than or equal to 1.');
        }
     ...
     * Gets source
     *
     * @return \Rvvup\Api\Model\ApplicationSource|null
     */
     ...
     * Sets success_url
     *
     * @param string|null $success_url The URL to redirect the user to after the checkout is completed successfully.                          This field supports the template variable `{{CHECKOUT_ID}}` which will be replaced with the                          created checkouts ID.
     *
     * @return self
     */
