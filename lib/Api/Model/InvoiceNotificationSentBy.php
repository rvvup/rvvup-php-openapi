...
/**
 * InvoiceNotificationSentBy Class Doc Comment
 *
 * @category Class
 ...
 */
class InvoiceNotificationSentBy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceNotificationSentBy';
    ...
    */
     ...
     * Sets given_name
     *
     * @param string|null $given_name The given name of the sender.
     *
     * @return self
     */
     ...
     * Sets surname
     *
     * @param string|null $surname The surname of the sender.
     *
     * @return self
     */
