...
class Payment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'decline_reason' => '\Rvvup\Api\Model\PaymentDeclineReason',
        'id' => 'string',
        'method' => '\Rvvup\Api\Model\PaymentMethod',
        'payment_session_id' => 'string',
        'settlement_status' => '\Rvvup\Api\Model\PaymentSettlementStatus',
        'status' => '\Rvvup\Api\Model\PaymentStatus',
        'summary' => '\Rvvup\Api\Model\PaymentSummary',
        'updated_at' => '\DateTime',
        'void_reason' => '\Rvvup\Api\Model\PaymentVoidReason'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['capture_type'] === null) {
            $invalidProperties[] = "'capture_type' can't be null";
        }
     ...
     *
     * @param \DateTime|null $authorization_expires_at The datetime when the payment's authorization expires.
     *
     * @return self
     */
     ...
     * Gets capture_type
     *
     * @return \Rvvup\Api\Model\PaymentCaptureType
     */
    ...
    {
        if (is_null($capture_type)) {
            throw new \InvalidArgumentException('non-nullable capture_type cannot be null');
        }
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The datetime when the payment was created.
     *
     * @return self
     */
     ...
     * Gets decline_reason
     *
     * @return \Rvvup\Api\Model\PaymentDeclineReason|null
     */
     ...
     * Sets id
     *
     * @param string $id The unique ID for the payment.
     *
     * @return self
     */
     ...
     *
     * @param string $payment_session_id The ID of the payment session that the payment was created in.
     *
     * @return self
     */
     ...
     *
     * @return \Rvvup\Api\Model\PaymentSettlementStatus
     */
     ...
     * Gets status
     *
     * @return \Rvvup\Api\Model\PaymentStatus
     */
     ...
     * Gets summary
     *
     * @return \Rvvup\Api\Model\PaymentSummary
     */
     ...
     * Sets summary
     *
     * @param \Rvvup\Api\Model\PaymentSummary $summary summary
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime $updated_at The datetime when the payment was last updated.
     *
     * @return self
     */
     ...
     * Gets void_reason
     *
     * @return \Rvvup\Api\Model\PaymentVoidReason|null
     */
