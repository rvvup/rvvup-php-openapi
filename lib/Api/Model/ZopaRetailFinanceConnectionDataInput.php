...
/**
 * ZopaRetailFinanceConnectionDataInput Class Doc Comment
 *
 * @category Class
 ...
 */
class ZopaRetailFinanceConnectionDataInput extends ConnectionDataInput
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ZopaRetailFinanceConnectionDataInput';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['authentication_number'] === null) {
            $invalidProperties[] = "'authentication_number' can't be null";
        }
        if ($this->container['oauth_client_id'] === null) {
            $invalidProperties[] = "'oauth_client_id' can't be null";
        }
        if ($this->container['oauth_client_secret'] === null) {
            $invalidProperties[] = "'oauth_client_secret' can't be null";
        }
        if ($this->container['token_number'] === null) {
            $invalidProperties[] = "'token_number' can't be null";
        }
     ...
     *
     * @param string $authentication_number authentication_number
     *
     * @return self
     */
     ...
     *
     * @param string $oauth_client_secret oauth_client_secret
     *
     * @return self
     */
     ...
     * Sets token_number
     *
     * @param string $token_number token_number
     *
     * @return self
     */
