...
/**
 * AccountStatementCreditNoteCreateInput Class Doc Comment
 *
 * @category Class
 ...
 */
class AccountStatementCreditNoteCreateInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountStatementCreditNoteCreateInput';
    ...
    */
     ...
     * Sets metadata
     *
     * @param array<string,string>|null $metadata Key value pairs to store additional information about the credit note.
     *
     * @return self
     */
     ...
     * Sets reference
     *
     * @param string $reference The reference of the credit note.
     *
     * @return self
     */
