...
class InvoicesApi
{
     ...
     * @param  string|null $idempotency_key Idempotency Key (optional)
     ...
     * @param  int|null $offset pagination offset (optional)
     * @param  int|null $limit pagination limit (optional)
     * @param  string|null $q invoice search query (optional)
     * @param  string|null $customer_account_id filter to a customer account (optional)
