...
class OrdersApi
{
     ...
     * @param  int|null $limit pagination limit (optional)
     * @param  string|null $amount_gte amount greater than or equal to (optional)
     * @param  string|null $amount_lte amount less than or equal to (optional)
     * @param  string|null $reference filter by reference (optional)
     * @param  string|null $currency filter by currency (optional)
     * @param  string|null $status filter by status (optional)
     * @param  string[]|null $payment_methods filter by payment methods (optional)
     * @param  string|null $q search query (optional)
     * @param  string|null $customer_account_id filter by customer account id (optional)
     * @param  string|null $created_at_gte created after (inclusive) (optional)
     * @param  string|null $created_at_lte created before (inclusive) (optional)
     * @param  string|null $address_name filter by address name (optional)
     * @param  string|null $address_phone_number filter by address phone number (optional)
     * @param  string|null $address_company filter by address company (optional)
     * @param  string|null $address_line1 filter by address line 1 (optional)
     * @param  string|null $address_line2 filter by address line 2 (optional)
     * @param  string|null $address_city filter by address city (optional)
     * @param  string|null $address_state filter by address state (optional)
     * @param  string|null $address_postcode filter by address postcode (optional)
     * @param  string|null $address_country_code filter by address country code (optional)
